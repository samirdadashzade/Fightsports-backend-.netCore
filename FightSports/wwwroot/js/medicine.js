...
function medicineBigTitleCon () {
    let width = $('.img_main').width()
    $('.big_title_container').css({width : width})
}

function medicineSmallCons () {
    let width = $('.related_img').width()
    $('.related_con_txt_con').css({width : width})
}
