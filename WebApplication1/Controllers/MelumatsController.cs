...
namespace WebApplication1.Controllers
{
    ...
    public class MelumatsController : Controller
    {
        ...
        public MelumatsController(ApplicationDbContext context, IHostingEnvironment hostingEnvironment)
        {
        ...
        {
            var ApplicationDbContext = _context.Melumat.Include(m => m.SportCategory);
